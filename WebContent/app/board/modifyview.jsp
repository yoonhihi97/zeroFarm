...
<body>
	...
	<section class="contact-section padding_top">
		...
		<form method="post" name="boardForm"
			action="${pageContext.request.contextPath}/board/BoardModifyOk.bo?boardnum=${board.boardnum}"
			...
			<div id="container">
				...
				<div class="bodytext_area box_inner">
					...
					<li class="bbs_title"><select style="border-style: none;"name="boardtype">
								<option>선택</option>
							...
							<div class="editor_content">
								<tr height="300px">
									...
									<td><textarea name="boardcontents"
											style="width: 800px; height: 400px; border: 0 solid black;"resize:none;">${board.boardcontents}</textarea>
								...
								<c:forEach var="i" begin="0" end="1">
									<tr>
										...
										<c:choose>
											...
											</c:choose> <label class="flabel" for="fileInput${i+1}">첨부하기</label> <input
											class="finput" name="file${i+1}" id="fileInput${i+1}"
											type="file">
											</td>
									</tr>
								</c:forEach>
