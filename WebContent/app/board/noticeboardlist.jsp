...
<header class="main_menu home_menu">
	...
	<section class="contact-section padding_top">
		<c:set var="noticeboardlist" value="${requestScope.noticeboardlist}" />
			...
			<div class="bodytext_area box_inner">
				...
				<table class="bbsListTbl" summary="제목, 작성자, 날짜, 타입, 조회수 등을 제공하는 표">
					...
					<tbody>
						<c:choose>
							<c:when
								test="${noticeboardlist != null and fn:length(noticeboardlist)>0 }">
								<!-- 보여줄 게시글 목록이 있음 -->
				...
				<div class="pagenation">
					<tr align="center" valign="middle">
						<td><c:if test="${page>1}">
								<a class="arr prev"
									href="${pageContext.request.contextPath}/board/NoticeBoardList.bo?page=${page-1}"></a>
								...
								<c:choose>
									...
									<c:otherwise>
										<a class="page_num"
											href="${pageContext.request.contextPath}/board/NoticeBoardList.bo?page=${i}" >${i}</a>
									</c:otherwise>
								</c:choose>
