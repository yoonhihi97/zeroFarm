...
<div class ="aside">
	...
	<div>
		<form action="${pageContext.request.contextPath}/user/mailAuthentic_delete.us" method="post" name="checkform">
			...
			<%-- 기존 이메일 인증과 다른 경로로 보내줌 --%>
				<input type ="button" class="btn_1 btn_area" onclick="deleteId()" value="인증번호 보내기"/>
			</div>
	</div>
		   <!--::footer_part start::-->
    <footer>
