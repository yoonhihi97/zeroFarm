...
<div class ="info">
	...
	<article>
		<br>
		<h5>1. 제로팜 회원 서비스 사용 불가 </h5>
		<p>회원 탈퇴시 제로팜에 
		<span id ="strong">로그인 할 수 없으며</span>, 
		현재 계정으로 이용하시던 모든 구매,<br>
		판매 서비스와 회원 서비스 이용이
		<span id ="strong"> 불가합니다.</span></p>
		<br>
		
		<h5>2. 제로팜 잔여 포인트 복구/환불 불가 </h5>
		<p>회원 탈퇴시 현재 계정에 남아있는 
		<span id ="strong">모든 포인트가 소멸되며</span>,<br>
		이로 인한 손해는 본 회사에서
		<span id ="strong"> 책임지지 않습니다.</span></p>
		<br>
		<h5>3. 계정 탈퇴 후 복구약관</h5>
		<p>회원 탈퇴 후 복구를 원하셔도 계정 복구가 <span id ="strong">불가능하오니</span>,<br>
		신중하게 선택하여 주시길 바랍니다.
		</p>
		<br>
		<h5>4. 회원 탈퇴 과정</h5>
		<p>본 회원탈퇴는 현재 로그인 한 계정만 삭제 가능하오니,<br>
		이메일 인증을 진행하여 주시길 바랍니다.</p>
		<br>	
	</article>
	<form>
		<input type ="button" class ="btn_2 btn_area" value ="탈퇴하기" onclick ="delete_openChild();">
	</form>
</div>


	<section class="menu_part" style = "margin-top: 30px;">
		<div class ="info_menu">
			<ul id ="menu_select">
				...
				<li class="t4 menu_select"><a href="#" class="btn_area_select btn_2" >회원 탈퇴</a></li>
