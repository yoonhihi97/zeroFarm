...
<div class ="header">
	<div class ="logo">
		<span class="logo_title">
			<img src="${pageContext.request.contextPath}/aranoz-master/aranoz-master/img/logo.png" alt="logo"> </a>
		</span><hr>
	</div>
</div>
<!-- 본문 -->	
<div class ="aside">
	...
	<div>
		<form action="${pageContext.request.contextPath}/user/mailAuthentic_find.us" method="post" name="checkform">
			...
			<%-- 기존 이메일 인증과 다른 경로로 보내줌 --%>
				<input type ="button" class="btn_1 btn_area" onclick="findId()" value="임시 비밀번호 보내기"/>
			</div>
		</form>
