  ...
  <section class="contact-section mypage_wrap">
    <div class="container">
              ...
              <div class="regForm">
                      <ul class="reg_list">
                        <li class="clear">
                          ...
                          <div class="reg_content"><span>${sessionScope.user.getEmail() }</span></div>
                        </li>
                          <li class="clear">
                              <span class="tit_lbl">이름</span>
                              <div class="reg_content">${sessionScope.user.getName() }</div>
                          </li>
                          <li class="clear">
                              <span class="tit_lbl">휴대폰</span>
                              <div class="reg_content"><span>${sessionScope.user.getPhonenum() }</span></div>
                          </li>
                          <li class="clear">
                            <span class="tit_lbl">포인트</span>
                            <div class="reg_content"><span>${sessionScope.user.getPoint() }P</span></div>
                          </li>
                          <li class="clear">
                              <span class="tit_lbl">주소</span>
                              <div class="reg_content">${sessionScope.user.getAddress() }</div>
                          </li>
                      </ul>
              </div>
          </dd>
      ...
      <section class="menu_part">
        <div class ="info_menu">
          <ul id ="menu_select">
            <li class="t1 menu_select"><a href="#" class="btn_area_select btn_2">내 정보보기</a></li>
